    ...
    <div className="w-11/12 m-auto md:py-10 md:w-10/12">
      <div className="flex flex-col md:flex-row pt-10 items-center">
        ...
        <div className="my-2 md:w-1/2">
          ...
          <div className="flex justify-between mt-4">
            <p
              className={`text-gray-500 dark:text-white p-2 rounded-lg cursor-pointer ${
                activeButton === "description"
                  ? "bg-orange-100 text-orange-700 dark:bg-custom2 dark:text-white"
                  : ""
              }`}
          ...
          <div className="hidden md:block">
            <div className="flex items-center w-full">
              ...
              <button
                className="bg-black dark:bg-orange-400 text-white lg:w-2/3 md:flex-1 lg:flex-none py-2 rounded-md hover:opacity-80"
                onClick={() => addToCart(selectedProductData)}
              >
                Add to Cart
              </button>
            </div>
      ...
      <div className="flex items-center py-5 border-t-2 md:hidden">
        <div className="flex items-center w-full justify-center">
          <img src={wishlist} alt="wishlist" className="mr-4" />
          <button
            className="bg-black text-white flex-1 py-2 rounded-md md:w-1/2 md:flex-none hover:opacity-80 dark:bg-orange-400"
            onClick={() => addToCart(selectedProductData)}
          >
            Add to Cart
          </button>
