      ...
      <div className="grid grid-cols-1 gap-20 md:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <p className="dark:text-white">
            At NendoNest, we invite you to explore a world where artistry meets
            play, where each figurine is a miniature marvel, and where the
            epitome of Nendoroid craftsmanship awaits. Our collection is
        ...
        <div>
          ...
          <p className="dark:text-white">
            ...
            meticulous craftsmanship and dedication of the artists behind these
            miniature marvels. From beloved characters to iconic scenes, every
            piece is a masterpiece that captures the essence of your favorite
        ...
        <div>
          ...
          <p className="dark:text-white">
            ...
            play. We strive to provide a platform where collectors can find the
            most sought-after Nendoroids, appreciate the craftsmanship behind
            each piece, and connect with a community that shares their passion.
          </p>
        </div>
        <div>
          <h1 className="text-2xl font-bold mb-4 dark:text-white">
          ...
          <p className="dark:text-white">
            ...
            figurine tells a story and every collector becomes part of a vibrant
            community. Whether you're looking to enhance your collection or
            simply admire the artistry behind Nendoroids, NendoNest is your
            destination for the finest in miniature craftsmanship.
          </p>
        </div>
        <p className="dark:text-white">
          Thank you for choosing NendoNest. Let the symphony of precision and
          charm begin.
        </p>
      </div>
    </div>
